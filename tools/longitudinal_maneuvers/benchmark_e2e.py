...
def print_comparison_table(experimental_metrics: ComfortMetrics,
  ...
  # Overall score
  print("\n" + "="*80)
  score_diff = experimental_metrics.comfort_score - chill_metrics.comfort_score
  print(f"{'OVERALL COMFORT SCORE (0-100)':<35} {experimental_metrics.comfort_score:>10.1f}{'':<10} " +
        f"{chill_metrics.comfort_score:>10.1f}{'':<10} {score_diff:>+10.1f}")
  print("="*80)
