...
class GuiScrollPanel2:
  def __init__(self, horizontal: bool = True, handle_out_of_bounds: bool = True) -> None:
    ...
    # Use larger velocity buffer on hardware with touchscreen for smoother scrolling
    self._velocity_buffer: deque[float] = deque(maxlen=12 if HARDWARE.capabilities.has_touchscreen else 6)
