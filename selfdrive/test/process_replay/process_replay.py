...
CONFIGS = [
  ...
  ProcessConfig(
    ...
    ignore=[
      ...
      "longitudinalPlan.e2eAcceleration",
      "longitudinalPlan.modelConfidence",
      "longitudinalPlan.modelAcceleration",
      "longitudinalPlan.modelVelocity",
      "longitudinalPlan.brakeDisengageProb",
    ],
    init_callback=get_car_params_callback,
    should_recv_callback=MessageBasedRcvCallback("modelV2"),
    tolerance=NUMPY_TOLERANCE,
