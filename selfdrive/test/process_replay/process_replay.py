...
CONFIGS = [
  ...
  ProcessConfig(
    ...
    ignore=["logMonoTime", "longitudinalPlan.processingDelay", "longitudinalPlan.solverExecutionTime", "longitudinalPlan.e2eAcceleration", "longitudinalPlan.modelConfidence"],
    init_callback=get_car_params_callback,
    should_recv_callback=MessageBasedRcvCallback("modelV2"),
    tolerance=NUMPY_TOLERANCE,
  ),
